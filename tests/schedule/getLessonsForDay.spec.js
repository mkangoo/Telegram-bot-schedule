import { dataBase } from '../../data/schedule'
import { getLessonsForDay } from '../../src/core/schedule'
...
describe('Works when today is weekday', () => {
	...
	it('Works for weekday', () => {
		expect(getLessonsForDay(WEEK_DAY, MOCK_SCHEDULE_DATA, 4)).toMatchSnapshot()
	}),
		it('Works for weekday', () => {
			expect(getLessonsForDay(WEEK_DAY, MOCK_SCHEDULE_DATA, 3)).toMatchSnapshot()
		})
})
